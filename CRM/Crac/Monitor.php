        ...
        if ($interval) { // interval 0 means 'disabled'
            ...
            CRM_Core_Resources::singleton()->addVars(
                ...
                [
                    ...
                    'ignore_text'     => E::ts(
                        "This Mailing is currently edited multiple times. If multiple people will save their changes, some of it <strong>will be lost</strong>. Hope you know what you're doing."
                    ),
                ]
            );
